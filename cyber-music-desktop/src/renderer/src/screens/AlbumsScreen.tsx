  ...
  return (
    <div className="flex-1 px-8 py-8 max-w-full w-full">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {Object.values(albums).map((album: any, i: number) => (
          <div key={album.name} className="flex flex-col items-center p-4 rounded-xl hover:bg-black/5 dark:hover:bg-white/5 transition-all cursor-pointer group"
